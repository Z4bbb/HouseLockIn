# -*- coding: utf-8 -*-
"""Housing_Lockin_Analysis.pdf.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1asqDvTVXpHo8wwAPEdDSQkh4w8Hvt11D
"""

!pip install pyfredapi pandas matplotlib
...
try:
    ...
    raise ValueError("FRED_API_KEY not found! Please add it to the 🔑 Secrets tab on the left sidebar.")

print("Pulling live data from FRED API...")

# Fetch data via pyfredapi
...
fig1.tight_layout()
fig1.savefig('chart1_rate_shock.png', dpi=300)
plt.show()
...
fig2.tight_layout()
fig2.savefig('chart2_supply_freeze.png', dpi=300)
plt.show()

# Chart 3: Price Paradox
...
fig3.tight_layout()
fig3.savefig('chart3_price_paradox.png', dpi=300)
plt.show()

# -----------------------------------------------------------------------------
# 4. Auto-Download Deliverables
# -----------------------------------------------------------------------------
print("\nProcessing complete! Initiating file downloads...")
files.download(output_csv)
files.download('chart1_rate_shock.png')
files.download('chart2_supply_freeze.png')
files.download('chart3_price_paradox.png')